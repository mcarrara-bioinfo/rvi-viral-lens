process write_classification_report {
    ...
    script:
        ...
        echo "Sample_ID,Taxon_ID,Virus,Type,Flu_Segment,Percentage_of_Genome_Covered,Total_Mapped_Reads,Longest_non_N_segment,Percentage_of_N_bases" > ${output_report_file}
